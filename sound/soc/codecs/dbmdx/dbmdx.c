...
void dbmdx_set_ldo_gpio(int num)
{
    dmic_ldo_en_pin = num;        
}
#endif
...
#if defined(CONFIG_KNOWLES_DMIC_CONTROL)
		gpio_direction_output(dmic_ldo_en_pin, 0);
		usleep_range(1000, 1100);
		gpio_direction_output(dmic_ldo_en_pin, 1);
		pr_info("%s : dmic_ldo reset\n", __func__);
#endif
		return -EIO;
	}
