...
static int sdhci_msm_probe(struct platform_device *pdev)
{
	...
	if (t_flash_detect_dev == NULL && !strcmp(host->hw_name, "c084000.sdhci")) {
#else
...
#if defined(CONFIG_NO_DETECT_PIN)
	if (sd_info_dev == NULL && !strcmp(host->hw_name, "c084000.sdhci")) {
#else
...
#if defined(CONFIG_NO_DETECT_PIN)
	if (sd_data_dev == NULL && !strcmp(host->hw_name, "c084000.sdhci")) {
#else
	...
	if (mmc_data_dev == NULL && !strcmp(host->hw_name, "c0c4000.sdhci")) {
